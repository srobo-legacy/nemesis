...
def test_team_leader_can_set_team_leader():
    ...
    assert User("student_coll1_1").is_teacher

    User("student_coll1_1").make_student() # Clean up

def test_team_leader_can_become_student():
    User("student_coll1_1").make_teacher() # We need to test against another teacher, because team leaders demoting themselves is not allowed
